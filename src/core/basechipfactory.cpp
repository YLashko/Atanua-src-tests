...
static const char *chip74266     = "74266";
...
Chip * BaseChipFactory::build(const char *aChipId)
{
    ...
    if (strcmp(xnor_chip,   aChipId) == 0) return new XNORChip(1);
    ...
    if (strcmp(chip74266, aChipId) == 0) return new Chip74266();
...
void BaseChipFactory::getSupportedChips(vector<char *> aChipList[5])
{
    ...
    aChipList[1].push_back(mystrdup(chip74266));
